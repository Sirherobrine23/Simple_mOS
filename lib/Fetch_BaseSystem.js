...
const MacOS_Products = require("./FetchOS/products.json")
...
function FetchOS(System = "Catalina"){
    ...
    execSync(`python3 ${resolve(__dirname, "./FetchOS/FetchOS.py")} ${ArgV.join(" ")}`, {cwd: resolve(__dirname, "./FetchOS")}).toString()
    return {
